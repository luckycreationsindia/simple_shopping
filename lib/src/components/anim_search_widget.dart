...
class AnimSearchBar extends StatefulWidget {
  ...
  /// boxShadow - Box Shadow for Search Icon
  /// borderRadius - Border Radius
  /// showShadowOnOpen - Show Box Shadow on Open
  /// onToggle - On Click of Search Button
  ...
  const AnimSearchBar({
    ...
    /// Box Shadow for Search Icon
    this.boxShadow,

    /// Border Radius
    this.borderRadius,

    /// Show Box Shadow on Open
    this.showShadowOnOpen,
...
class _AnimSearchBarState extends State<AnimSearchBar>
  ...
  Widget build(BuildContext context) {
    List<BoxShadow>? boxShadow = widget.boxShadow;
    Color? mainColor = widget.color;
    if (widget.showShadowOnOpen != null && widget.showShadowOnOpen!) {
      if (toggle == 0) {
        boxShadow = [];
    ...
    return Container(
      ...
      child: AnimatedContainer(
        duration: Duration(milliseconds: widget.animationDurationInMilli),
        height: 38.0,
        width: (toggle == 0) ? 38.0 : widget.width,
              ...
              child: AnimatedOpacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: mainColor,
                    borderRadius:
                        widget.borderRadius ?? BorderRadius.circular(30.0),
                  ),
